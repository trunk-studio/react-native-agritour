...
export default class AppRoutes extends Component {
  ...
  componentWillMount() {
    let url;
    if (Platform.OS === 'ios') {
      url = 'https://s3-ap-northeast-1.amazonaws.com/s3.trunksys.com/agritour/qa/packager/metadata.json';
    } else {
      url = 'https://s3-ap-northeast-1.amazonaws.com/s3.trunksys.com/agritour/qa/packager/metadata.android.json';
    }
    fetch(url)
